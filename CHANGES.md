...
* [#2698](https://github.com/ckeditor/ckeditor-dev/issues/2698): Added the [`Add htmlParser.element.findOne`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_htmlParser_element.html#method-findOne) function.
